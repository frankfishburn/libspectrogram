...
void STFT_Test_4::SetUp(){
    ...
    power = std::vector<double>{0.022942, 0.031642, 0.117803, 0.009019, 
    ...
    phase = std::vector<double>{0,   -0.1136,   -2.6167,    0,
                                0,   -2.0363,    1.7501,    0,
                                0,   -3.0426,    0.6256,    0,
                                0,    2.3869,   -1.0981,    0,
                                0,   -0.7533,   -2.9982,    0 };
...
void STFT_Test_5::SetUp(){
    ...
    // Noisy 2.5 Hz signal
    input = std::vector<double>{0.0, 0.655098, 0.0, 1.162612, 0.0, 0.118998, 0.0, -0.501636, 0.0, 0.959744, 0.0, 1.340386, 
...
void STFT_Test_6::SetUp(){
    ...
    power = std::vector<double>{0.022942, 0.022594, 0.005996, 0.053877, 0.119506, 0.128965, 0.084413, 0.036440, 0.009019, 
